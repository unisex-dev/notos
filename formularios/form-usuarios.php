       <form id="contact-form" class="contact-form" name="form-<?php echo get_author_name(); ?>" method="post" action="#">
          ...
          <div class="row">
            <div class="form-group col-md-6">
                ...
                <input type="text" name="surname" class="form-control" required="required" tavindex="2" accesskey="A" title="Apellido:" placeholder="Apellido">
                <input type="email" name="email" class="form-control" required="required" tavindex="3" accesskey="E" title="E-Mail:" placeholder="Su Direccion Email">
